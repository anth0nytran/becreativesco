  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-accent-primary focus-visible:ring-accent-primary/50 focus-visible:ring-[3px]",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-accent-primary/30 bg-transparent shadow-xs text-white hover:bg-accent-primary/10 hover:text-accent-primary",
        secondary:
          "bg-dark-card text-white shadow-xs hover:bg-dark-card/80",
        ghost:
          "text-white hover:bg-accent-primary/10 hover:text-accent-primary",
